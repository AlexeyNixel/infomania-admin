...
const menuItem: { [key: string]: any } = reactive({
  title: '',
  link: '',
  slug: '',
...
<template>
  <div class="flex flex-col items-center justify-center h-full w-full">
    <div>
      ...
      <div v-if="menuItem.menuItemType === 'LINK'" class="flex flex-col my-2">
        <div>Ссылка</div>
        <el-input v-model="menuItem.link" />
      </div>
      <div class="flex my-3">
        <el-button @click="handleCreateMenuItem()">Обновить</el-button>
      </div>
    </div>
  </div>
</template>
